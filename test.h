...
// Lots of inserts and removes
    bool test8()
    {
        ...
        // Expected trees
        std::string expected_tree_1 = "7 2 9 1 4 3 5 6"; //remove 8
        std::string expected_tree_2 = "7 1 9 4 3 5 6"; //remove 2
        std::string expected_tree_3 = "6 1 9 4 3 5"; //remove 7
        std::string expected_tree_4 = "6 1 9 3 5"; // remove 4
        std::string expected_tree_5 = "6 1 9 3"; //remove 5
        std::string expected_tree_6 = "6 1 9"; //remove 3
        std::string expected_tree_7 = "6 9"; //remove 1
        std::string expected_tree_8 = "6"; //remove 9
        ...
        for(int i = 0; i<nin; ++i)
        {
            ...
            //std::cout << level_order(bst.root_) << std::endl;
        }
        //ASSERT_TRUE(level_order(bst.root_).compare(expected_tree) == 0)
...
// Test double left-right rotation
    ...
    bool test5()
    {
        ...
        for (int i = 0; i < 10; i++) {
            avl.insert(in[i]);
            //std::cout << level_order(avl.getRootNode()) << std::endl;
        }
    ...
    bool test6()
    {
        ...
        // POTENTIALLY ALTERED CODE - COMMENTED OUT TO AVOID USE
        /* std::string expected_tree_level_order = "23 15 40 11 21 26 42";
        ...
        ASSERT_TRUE(avl.remove(87));
        //std::cout << "remove 1 " << level_order(avl.getRootNode()) << std::endl;
        ASSERT_TRUE(avl.remove(82));
        //std::cout << "remove 2 " << level_order(avl.getRootNode()) << std::endl;
        ASSERT_TRUE(avl.remove(69));
        //std::cout << "remove 3 " << level_order(avl.getRootNode()) << std::endl;

        std::string tree_level_order = level_order(avl.getRootNode());
        ASSERT_TRUE(tree_level_order.compare(expected_tree_level_order) == 0)

        ASSERT_TRUE(avl.remove(11));
        //std::cout << "remove 4 " << level_order(avl.getRootNode()) << std::endl;
        ASSERT_TRUE(avl.remove(15));
        //std::cout << "remove 5 " << level_order(avl.getRootNode()) << std::endl;
        ASSERT_TRUE(avl.remove(21));
        //std::cout << "remove 6 " << level_order(avl.getRootNode()) << std::endl;
        expected_tree_level_order = "40 23 42 26";
        tree_level_order = level_order(avl.getRootNode());
        ASSERT_TRUE(tree_level_order.compare(expected_tree_level_order) == 0)

        ASSERT_TRUE(avl.remove(42));
        //std::cout << "remove 7 " << level_order(avl.getRootNode()) << std::endl;
        expected_tree_level_order = "26 23 40";
        tree_level_order = level_order(avl.getRootNode());
        ASSERT_TRUE(tree_level_order.compare(expected_tree_level_order) == 0)

        ASSERT_TRUE(avl.remove(26));
        //std::cout << "remove 8 " << level_order(avl.getRootNode()) << std::endl;
        ASSERT_TRUE(avl.remove(23));
        //std::cout << "remove 9 " << level_order(avl.getRootNode()) << std::endl;
        ASSERT_TRUE(avl.remove(40));
        //std::cout << "remove 10 " << level_order(avl.getRootNode()) << std::endl;
        expected_tree_level_order = "";
        tree_level_order = level_order(avl.getRootNode());
        ASSERT_TRUE(tree_level_order.compare(expected_tree_level_order) == 0)
